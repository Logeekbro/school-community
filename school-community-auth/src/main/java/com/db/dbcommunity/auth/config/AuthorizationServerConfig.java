...
import com.db.dbcommunity.auth.security.details.client.ClientDetailsServiceImpl;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public TokenEnhancer tokenEnhancer() {
        return (accessToken, authentication) -> {
            ...
            if (principal instanceof CommunityUserDetails){
                CommunityUserDetails CommunityUserDetails = (CommunityUserDetails) principal;
                additionalInfo.put("userId", CommunityUserDetails.getUserId());
