package com.db.dbcommunity.auth.config;

import cn.hutool.json.JSONUtil;
import com.db.dbcommunity.auth.security.details.user.CommunityUserDetailServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private final CommunityUserDetailServiceImpl communityUserDetailsService;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .authorizeRequests().antMatchers(AuthConstant.URI_PREFIX+"/**").permitAll()
    ...
    public DaoAuthenticationProvider daoAuthenticationProvider() {
        ...
        provider.setUserDetailsService(communityUserDetailsService);
